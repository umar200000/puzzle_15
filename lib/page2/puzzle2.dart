...
class _Puzzle2State extends State<Puzzle2> {
  bool t = false;
  HiveRep2 hiveRep = HiveRep2();
  GlobalKey<ScaffoldState> _key = GlobalKey();
  int count = 0;
  List<int> list = List.generate(25, (index) => index);
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: list[index] != 0 ? Color(0xff5441F0) : Colors
                            .white,
  ...
  changeIndex(int i) {
    ...
    int threeleft = i - 5;
    int threeright = i + 5;
    if(oneleft==zeroIndex && i%5!=0) builder1(i, oneleft);
    else if(oneright==zeroIndex && i%5!=4) builder1(i, oneright);
